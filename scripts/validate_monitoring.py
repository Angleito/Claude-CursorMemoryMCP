...
from src.metrics import metrics_collector, PerformanceMonitor, DatabaseHealthChecker
from monitoring.audit_logger import audit_logger, AuditLogger
...
class MonitoringValidator:
    ...
    def test_prometheus_metrics(self):
        ...
        try:
            from src.metrics import (
                REQUEST_COUNT, REQUEST_DURATION, MEMORY_COUNT, USER_COUNT,
                ACTIVE_CONNECTIONS, SEARCH_DURATION, EMBEDDING_DURATION,
                ERROR_COUNT, DATABASE_OPERATIONS, CACHE_HIT_RATE,
                API_REQUEST_SIZE, API_RESPONSE_SIZE, SYSTEM_MEMORY_USAGE,
                SYSTEM_CPU_USAGE
            )
    ...
    def test_metrics_collector(self):
        ...
        try:
            ...
            metrics_collector.record_error("test_error", "Test error message", "test_component")
    ...
    def test_prometheus_config(self):
        ...
        try:
            ...
            mem0ai_jobs = [job for job in scrape_configs if job.get("job_name") == "mem0ai"]
            if not mem0ai_jobs:
    ...
    def test_alert_rules(self):
        ...
        try:
            rules_path = Path(__file__).parent.parent / "config" / "prometheus" / "alert_rules.yml"
            ...
            self.add_success("Alert rules configuration", f"{total_rules} rules in {len(groups)} groups")
    ...
    def test_import_validation(self):
        ...
        try:
            # Test imports
            import src.metrics
            import monitoring.audit_logger
