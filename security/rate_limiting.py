...
from config.settings import get_settings, ROLE_RATE_LIMITS
...
class AdvancedRateLimiter:
    ...
    async def _check_suspicious_activity(self, request: Request) -> Tuple[bool, Dict[str, int]]:
        ...
        if suspicion_score >= 50:
            ...
            await self.redis.setex(block_key, 300, "suspicious_activity")  # 5 minute block
