...
from auth.models import APIKeyCreate
...
class APIKeyManager:
    ...
    async def get_api_key(self, key_id: uuid.UUID, requesting_user: User) -> APIKey:
    ...
    async def revoke_api_key(self, key_id: uuid.UUID, requesting_user: User) -> bool:
    ...
    async def delete_api_key(self, key_id: uuid.UUID, requesting_user: User) -> bool:
    ...
    async def rotate_api_key(
        self, key_id: uuid.UUID, requesting_user: User
    ) -> APIKeyResponse:
